...
import { AuthResponse } from '../types'; // Переконайтеся, що цей шлях коректний

// Імпортуємо іконки з lucide-react, які використовуються в дизайні
...
const LoginPage: React.FC = () => {
  ...
  console.error('Login error:', err); // Записуємо помилку в консоль
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col">
      {/* Header - Скопійовано з вашого Figma-дизайну */}
